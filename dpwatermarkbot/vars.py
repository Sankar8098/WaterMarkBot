...
class Vars:
    ...
    MESSAGE_DUMP = int(config("MESSAGE_DUMP", default=-1002197729525)) 
    ...
    LIMIT_CPU = config("LIMIT_CPU", default=False, cast=config.boolean)
    LIMIT_USER_USAGE = config("JOIN_CHECK", default=False, cast=config.boolean)
